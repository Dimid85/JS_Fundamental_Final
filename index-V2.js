...
class WebInterface {
  constructor(smartHome) {
    ...
    this.componentStatusButton = document.getElementById(
    ...
    this.addLightForm.addEventListener("submit", (event) =>
      this.handleAddLight(event)
    );
    this.addHeatingForm.addEventListener("submit", (event) =>
      this.handleAddHeating(event)
    );
    this.addBlindsForm.addEventListener("submit", (event) =>
      this.handleAddBlinds(event)
    );
    this.addTelevisionForm.addEventListener("submit", (event) =>
      this.handleAddTelevision(event)
    );
    this.componentStatusButton.addEventListener("click", (event) =>
      this.handleComponentStatus(event)
    );
  ...
  handleAddHeating(event) {
    ...
    const heatingTemperatureInput = document.getElementById(
      "heating-temperature"
    );
  ...
  handleAddTelevision(event) {
    ...
    const televisionChannelsInput = document.getElementById(
      "television-channels"
    );
    ...
    if (componentStates) {
      ...
      for (const component of componentStates) {
        ...
        if (component instanceof Light) {
          ...
          info += `, Power: ${component.power ? "ON" : "OFF"}, Channel: ${
            component.channels[component.currentChannelIndex]
